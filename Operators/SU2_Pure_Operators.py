...
def plaquette():
    path='/Users/giovannicataldi/Dropbox/PhD/Models/Operators/Op_SU2_Pure/'
    # ===================================================================================================
    ...
    # GENERATE MATRIX
    C_Bottom_Left=csr_matrix((data_Bottom_Left, (x_Bottom_Left-1, y_Bottom_Left-1)), shape=(9,9))
    # ===================================================================================================
    ...
    # GENERATE MATRIX
    C_Bottom_Right=csr_matrix((data_Bottom_Right, (x_Bottom_Right-1, y_Bottom_Right-1)), shape=(9,9))
    # ===================================================================================================
    ...
    # GENERATE MATRIX
    C_Top_Left=csr_matrix((data_Top_Left, (x_Top_Left-1, y_Top_Left-1)), shape=(9,9))    
    # ===================================================================================================
    ...
    # GENERATE MATRIX
    C_Top_Right=csr_matrix((data_Top_Right, (x_Top_Right-1, y_Top_Right-1)), shape=(9, 9))
    # ===================================================================================================
...
def plaquette_old():
    llambda=1
    data_plaquette=np.array([-1/sqrt(2),-1/sqrt(2),1/(2*(llambda**2)),1/(2*(llambda**2)),\
                    -(llambda**2)/2,-(llambda**2)/2,-sqrt(6)/4,-sqrt(6)/4,-sqrt(2)/4,-sqrt(2)/4])
    x_Bottom_Left=np.array([7,1,4,6,3,5,8,2,9,2])
    y_Bottom_Left=np.array([1,7,3,5,4,6,2,8,2,9])
    C_Bottom_Left=csr_matrix((data_plaquette, (x_Bottom_Left-1, y_Bottom_Left-1)), shape=(9, 9))
    # ===================================================================================================
    x_Bottom_Right=np.array([5,1,3,7,2,6,8,4,9,4])
    y_Bottom_Right=np.array([1,5,2,6,3,7,4,8,4,9])
    C_Bottom_Right=csr_matrix((data_plaquette, (x_Bottom_Right-1, y_Bottom_Right-1)), shape=(9, 9))
    # ===================================================================================================
    x_Top_Left=np.array([4,1,2,3,6,7,8,5,9,5])
    y_Top_Left=np.array([1,4,6,7,2,3,5,8,5,9])
    C_Top_Left=csr_matrix((-data_plaquette, (x_Top_Left-1, y_Top_Left-1)), shape=(9, 9))
    # ===================================================================================================
    x_Top_Right=np.array([2,1,5,6,3,4,8,7,9,7])
    y_Top_Right=np.array([1,2,3,4,5,6,7,8,7,9])
    C_Top_Right=csr_matrix((data_plaquette, (x_Top_Right-1, y_Top_Right-1)), shape=(9, 9))
    # ===================================================================================================
    return C_Bottom_Left, C_Bottom_Right, C_Top_Left, C_Top_Right