    ...
    def get_symmetry_operator(self):
        if self.sector_configs is not None:
            ...
            self.sym_ops = get_operators_nbody_term(
                sym_op_list, self.loc_dims, self.site_basis, self.lattice_labels
            )
